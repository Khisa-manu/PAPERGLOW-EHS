  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-3 sm:p-6 overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col my-auto max-h-[92vh]">
        ...
        {/* Header */}
        <div className="p-5 sm:p-6 bg-slate-900 text-white flex items-start justify-between">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-xs text-slate-400 mt-1">
                ...
                <span className="font-mono text-slate-300">
                  Report ID: {report.id.substring(0, 14)}...
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-amber-300 text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer border border-slate-700"
            >
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6 flex-1 text-slate-800 bg-slate-50/50">
          ...
          {isOverriding && (
            <div className="bg-amber-50 border border-amber-300 rounded-2xl p-4 sm:p-5 space-y-3 shadow-sm">
              <div className="flex items-center justify-between">
                <h4 className="font-heading font-bold text-amber-900 text-sm flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs font-semibold focus:outline-hidden focus:border-amber-500"
                  >
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs focus:outline-hidden focus:border-amber-500"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg text-xs font-bold text-slate-600 hover:bg-amber-100 transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-1.5 rounded-lg bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold transition-all shadow-xs cursor-pointer"
                >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs space-y-4">
            ...
            <div className="bg-slate-100/70 p-3 rounded-xl flex flex-wrap items-center justify-between gap-3 text-xs font-mono text-slate-700">
              <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {report.photos.map((photo, i) => (
                <div
                  ...
                  className="group bg-slate-900 rounded-2xl overflow-hidden border border-slate-200 hover:border-amber-500 transition-all cursor-pointer shadow-xs"
                >
            ...
            <div className="space-y-2">
              {ehsQuestions.map((q, idx) => {
                ...
                return (
                  <div
                    key={q.id}
                    className="p-3 rounded-xl border border-slate-200 flex items-start justify-between gap-3 text-xs bg-slate-50/50"
                  >
                    <div>
                    ...
                    <div className="shrink-0">
                      {isCompliant ? (
                        ...
                        <span className="flex items-center gap-1 font-bold text-rose-700 bg-rose-100/80 px-2 py-0.5 rounded text-[11px]">
