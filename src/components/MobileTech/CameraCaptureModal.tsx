        ...
        <div className="relative flex-1 bg-black min-h-[360px] sm:min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          {capturedPreview ? (
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="absolute bottom-3 left-3 right-3 bg-slate-950/85 backdrop-blur-md border border-slate-700/80 rounded-xl p-2.5 text-white text-[11px] font-mono space-y-1">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              {useLiveVideo ? (
                ...
                <div className="relative w-full h-full">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-slate-900/80 backdrop-blur-xs text-amber-300 text-[10px] font-mono px-2 py-0.5 rounded border border-amber-500/30">
              ...
              <div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center p-6">
                {config.guideShape === 'oval' && (
                  <div className="w-48 h-64 border-2 border-dashed border-amber-400/70 rounded-full shadow-[0_0_0_9999px_rgba(0,0,0,0.4)]" />
                )}
                {config.guideShape === 'rect' && (
                  <div className="w-64 h-48 border-2 border-dashed border-amber-400/70 rounded-2xl shadow-[0_0_0_9999px_rgba(0,0,0,0.4)]" />
                )}
                {config.guideShape === 'ladder' && (
                  <div className="w-44 h-72 border-2 border-dashed border-amber-400/70 rounded-lg shadow-[0_0_0_9999px_rgba(0,0,0,0.4)] flex flex-col justify-around py-4">
                    <div className="w-full border-b border-amber-300/40" />
                    <div className="w-full border-b border-amber-300/40" />
                    <div className="w-full border-b border-amber-300/40" />
                  </div>
                )}
                ...
                <p className="mt-4 text-center text-xs font-medium text-white/90 bg-slate-900/75 px-3 py-1 rounded-full backdrop-blur-xs max-w-xs shadow-xs">
                  {config.guideText}
                </p>
              </div>
              ...
              <div className="absolute top-3 right-3 flex items-center gap-1.5">
                <span className="flex items-center gap-1 bg-black/60 backdrop-blur-md px-2 py-1 rounded-md text-[10px] font-mono text-emerald-400 font-bold border border-emerald-500/30">
          ...
          {capturedPreview ? (
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 active:scale-98 text-white font-bold text-sm transition-all border border-slate-700 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-98 text-white font-bold text-sm shadow-lg shadow-emerald-950 transition-all cursor-pointer"
              >
            ...
            <div className="flex items-center justify-between px-4">
              ...
              <button
                ...
                className="p-3 rounded-full bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 transition-colors cursor-pointer"
                title="Flip Camera"
              >
              ...
              <button
                ...
                className="w-18 h-18 rounded-full border-4 border-amber-400 p-1 flex items-center justify-center group active:scale-90 transition-transform cursor-pointer shadow-lg shadow-amber-500/20"
                title="Capture Photo"
              >
                <div className="w-full h-full bg-white rounded-full group-hover:bg-amber-100 transition-colors flex items-center justify-center">
